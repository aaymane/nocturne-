  ...
  return (
    <section id={id} className={`scene flex ${className}`}>
      ...
      <div
        ...
        style={{
          background: topFade
            ? `radial-gradient(ellipse 160% 100% at 50% 50%, transparent 38%, rgba(2,2,2,0.58) 74%, rgba(2,2,2,0.88) 100%),
               linear-gradient(180deg, rgba(3,3,3,0.94) 0%, rgba(3,3,3,0.18) 14%, rgba(3,3,3,0.08) 58%, rgba(3,3,3,0.92) 100%)`
